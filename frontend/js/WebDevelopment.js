...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initDesktopFilters() {
    ...
    document.querySelector('.filter-btn[data-category="frontend"]').classList.add('active');
  ...
  function initMobileSlider() {
    ...
    // Find e-commerce index first
    let currentIndex = Array.from(filterButtons).findIndex(btn => btn.dataset.category === 'ecommerce');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ========== NEW CODE: SET ACTIVE DROPDOWN ITEM BASED ON CURRENT PAGE ==========
  // THIS IS THE ONLY ADDITION - EVERYTHING ABOVE REMAINS EXACTLY THE SAME
